...
void CLEAN_RIGHT(YYSTYPE & x, Args&& ... args) {
	...
	// for others, clear, becuase it's not needed as child
}
template <typename ... Args>
void CLEAN_RIGHT(YYSTYPE & x) {
}
...
ParseNode flatten_bin(ARG_IN pn, bool recursion_direction_right);// eliminate left/right recursion of an binary tree

...
OBJ_PARSER = $(OBJ_PARSER_ROOT)/attribute.$(OBJ_EXT)    $(OBJ_PARSER_ROOT)/Function.$(OBJ_EXT)    $(OBJ_PARSER_ROOT)/Intent.$(OBJ_EXT)    $(OBJ_PARSER_ROOT)/Intent.$(OBJ_EXT)    $(OBJ_PARSER_ROOT)/parser.$(OBJ_EXT)    $(OBJ_PARSER_ROOT)/tokenizer.$(OBJ_EXT)    $(OBJ_PARSER_ROOT)/Variable.$(OBJ_EXT) $(OBJ_PARSER_ROOT)/Type.$(OBJ_EXT)
